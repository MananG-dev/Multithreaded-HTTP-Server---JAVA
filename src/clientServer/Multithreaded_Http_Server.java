...
public class Multithreaded_Http_Server implements Runnable	{
	...
	public Multithreaded_Http_Server(Socket sk)	{
		this.socket = sk;
		Multithreaded_Http_Server.SocketChannel = sk.getRemoteSocketAddress();
	}
	...
	public static void main(String args[]) throws Exception	{
		try	{
			...
			while(true) {
				Multithreaded_Http_Server myServer = new Multithreaded_Http_Server(serverSocket.accept());
